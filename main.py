...
def analysis(leftbody,rightbody,leftneck,rightneck):
    analysisdict={}
    if leftbody > rightbody + 3 and leftbody < rightbody + 5:
        analysisdict['leftbody']='Minor left bend of the shoulders in posture'
    elif leftbody>rightbody+6 :
        analysisdict['leftbody']='Major left bend of shoulders in posture'
    elif rightbody > leftbody + 3 and rightbody < leftbody + 5:
        analysisdict['rightbody']='Minor right bend of the shoulders in posture'
    elif rightbody>leftbody+6 :
        analysisdict['rightbody']='Major right bend of shoulders in posture'


    if leftneck > rightneck + 3 and leftneck < rightneck + 5:
        analysisdict['leftneck']='Minor left bend of the neck in posture'
    elif leftneck>rightneck+6 :
        analysisdict['leftneck']='Major left bend of neck in posture'
    elif rightneck > leftneck + 3 and rightneck < leftneck + 5:
        analysisdict['rightneck']='Minor right bend of the  neck in posture'
    elif rightneck>leftneck+6 :
        analysisdict['rightneck']='Major right bend of neck in posture'

    return (analysisdict)
print('avgleftbend',avgleftbend)
print('avgrightbend',avgrightbend)

print(analysis(avgleftbend,avgrightbend,avgleftneck,avgrightneck))
patientanalysis=analysis(avgleftbend,avgrightbend,avgleftneck,avgrightneck)
def openairesponse(issue,key):
    if not issue:
        print('No issue')
        return
    a1ke=key
    ...
    prompt =f'this is my diagnoisis from a persons posture. {str(issue)}.can you give 5 exercises and stretches and tips in json format. Your json output should just have the exercise names and descriptions  ONLY for ease of access and should taylor to which side the user needs to do it on.'
...
print(openairesponse(patientanalysis))
